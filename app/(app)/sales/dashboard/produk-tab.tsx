    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="p-5 shadow-soft">
          ...
          <dl className="mt-4 grid grid-cols-3 gap-2 border-t border-border pt-3 text-center">
            ...
            <div>
              <dt className="text-xs text-muted-foreground">Pesanan/Keranjang</dt>
              <dd className="font-mono text-sm tabular-nums">
      ...
      <Card className="p-5 shadow-soft sm:p-6">
        ...
        <p className="mb-3 text-xs text-muted-foreground">
          Trafik tinggi tapi konversi di bawah rata-rata (
          {formatPercent(avgConv)}) — kandidat perbaikan judul / foto / harga
        </p>
        <Table>
          <TableHeader>
            <TableRow>
